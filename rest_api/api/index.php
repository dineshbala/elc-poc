...
function shippingaddress(){
    ...
    try {         
        ...
        {
           $db = getDB();
		   $sql1="INSERT INTO `tbl_useraddress` (`user_id`, `FirstName`, `LastName`, `Address1`, `Address2`, `Zipcode`, `City`, `State`, `Phone`) VALUES ('".$user_id."', '".$firstName."', '".$lastName."', '".$address1."', '".$address2."', '".$zipcode."', '".$city."', '".$state."', '".$phone."')";
           $stmt1 = $db->prepare($sql1);
           $stmt1->execute();
